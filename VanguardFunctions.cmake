...
MACRO (LINK_DEPENDENCY projName dependency IsPrivate)
	if (TARGET ${dependency})
		GET_TARGET_PROPERTY(targetType ${dependency} TYPE)
		if (${targetType} MATCHES INTERFACE_LIBRARY)
			GET_TARGET_PROPERTY(publicIncludeDirectories ${dependency} INTERFACE_INCLUDE_DIRECTORIES)	
		else()
