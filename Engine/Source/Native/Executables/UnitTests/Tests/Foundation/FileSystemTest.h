...
namespace Vanguard
{
	...
	//	printf("Engine Root: ");
	//	printf(engineRoot.GetFullPathName().GetCharPointer());
	//	printf("\n");

	//	printf("Config Directory: ");
	//	printf(configDir.GetFullPathName().GetCharPointer());
	//	printf("\n");

	//	printf("Engine Temp: ");
	//	printf(tempDir.GetFullPathName().GetCharPointer());
	//	printf("\n");
	...
	TEST_F(FileSystemTest, FileCreationAndDeletion)
	{
		...
		EXPECT_EQ(FileSystem::GetSystemTempDirectory(), File.GetParentDirectory());
