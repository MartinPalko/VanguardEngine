...
namespace Vanguard
{
	...
	public:
		...
		DynamicArray<Property*> GetProperties() const;
...
#define REGISTER_PROPERTY(ClassIdentifier, PropertyName) t->RegisterProperty(new Property(#PropertyName, offsetOf(&ClassIdentifier::PropertyName), typeid(decltype(ClassIdentifier::PropertyName)).hash_code()));
